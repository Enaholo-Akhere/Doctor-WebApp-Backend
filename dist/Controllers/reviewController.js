...
var getAllReviews = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0: return [4 /*yield*/, (0, reviewServices_1.getAllReviewServices)()];
            case 1:
                _a = _b.sent(), error = _a.error, data = _a.data, message = _a.message;
                if (error) {
                    res.status(404).json({ message: message, status: 'failed' });
                    return [2 /*return*/];
                }
                res.status(200).json({ message: message, status: 'successful', data: data });
                return [2 /*return*/];
        }
    });
}); };
...
var createReview = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var doctorId, id, body, _a, error, data, message;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
            ...
            case 1:
                _a = _b.sent(), error = _a.error, data = _a.data, message = _a.message;
                if (error) {
                    res.status(500).json({ message: message, status: false });
                    return [2 /*return*/];
                }
