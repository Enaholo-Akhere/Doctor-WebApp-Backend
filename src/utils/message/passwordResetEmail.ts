  ...
  <table align="center" cellpadding="0" cellspacing="0" width="100%" style="max-width:600px; background-color:#ffffff; margin:40px auto; border-radius:8px; overflow:hidden; border:1px solid #e2e8f0;">
    ...
    <tr>
      <td style="padding:32px 30px; color:#334155; font-size:15px; line-height:1.6;">
        <p style="margin:0 0 6px;">Hi there,</p>
        <p style="margin:0 0 28px; font-size:14px; color:#64748b;">
          Someone requested a password reset for your CareConnect account. Click the button below to set a new password. This link is valid for <strong style="color:#1e293b;">30 minutes</strong>.
        </p>
        ...
        <!-- Expiry Warning -->
        <table cellpadding="0" cellspacing="0" width="100%" style="background:#fffbeb; border:1px solid #fde68a; border-radius:10px; margin-bottom:24px;">
          <tr>
            <td style="padding:14px 16px; font-size:12px; color:#92400e; line-height:1.7;">
              ⚠️ <strong>This link expires in 30 minutes.</strong> If you don't reset your password in time, you'll need to request a new link.
            </td>
          </tr>
        </table>
        ...
        <!-- Fallback URL -->
        <p style="margin:0 0 8px; font-size:10px; text-transform:uppercase; letter-spacing:0.1em; font-weight:700; color:#94a3b8;">
          Button not working? Copy this link
        </p>
        <table cellpadding="0" cellspacing="0" width="100%" style="background:#f4fafa; border:1px solid #d4e9e8; border-radius:10px; margin-bottom:28px;">
          <tr>
            <td style="padding:13px 16px; font-size:12px; color:#0d8c81; word-break:break-all; line-height:1.6; font-family:'Courier New', monospace;">
              ${resetUrl}
            </td>
          </tr>
        </table>
        ...
        <table cellpadding="0" cellspacing="0" width="100%" style="background:#f0fdf9; border:1px solid #ccfbf1; border-radius:10px; margin-bottom:28px;">
          <tr>
            <td style="padding:14px 16px; font-size:12px; color:#475569; line-height:1.7;">
              🔒 If you didn't request a password reset, you can safely ignore this email — your password won't change. If you're concerned, please <a href="${supportUrl}" style="color:#0d9488; font-weight:600;">contact our support team</a>.
            </td>
          </tr>
        </table>
